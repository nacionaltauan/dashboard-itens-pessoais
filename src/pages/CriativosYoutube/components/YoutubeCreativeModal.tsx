...
interface YoutubeCreativeModalProps {
  creative: YoutubeCreativeData | null
  isOpen: boolean
  onClose: () => void
}

// Componente de gráfico de retenção de vídeo para YouTube
const YoutubeVideoRetentionChart: React.FC<{ creative: YoutubeCreativeData }> = ({ creative }) => {
...
const YoutubeCreativeModal: React.FC<YoutubeCreativeModalProps> = ({ creative, isOpen, onClose }) => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div
                ...
                style={{ aspectRatio: isVideo ? "16/9" : "1/1", maxHeight: "500px" }}
              >
                {creative.mediaUrl ? (
                  <div className="relative w-full h-full">
                    <iframe
                      ...
                      onError={(e) => {
                        console.error(`Erro ao carregar mídia YouTube`, e)
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-red-50 rounded-lg p-4 text-center">
                  <div className="text-2xl font-bold text-red-600">{formatCurrency(creative.totalSpent)}</div>
              ...
              {isVideo && <YoutubeVideoRetentionChart creative={creative} />}
            </div>
          </div>
        </div>
